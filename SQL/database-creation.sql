-- (user_login) By: Moaz Alaa
-- (user_status) By: Moaz Alaa
-- (user_info) By: Moaz Alaa
...
-- -----------------------------------------------------
-- Table `studdybuddy`.`user_login`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restful_api_demo`.`user_login` ;

CREATE TABLE IF NOT EXISTS `studdybuddy`.`user_login` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `studdybuddy`.`user_info` ;

CREATE TABLE IF NOT EXISTS `studdybuddy`.`user_info` (
  ...
  CONSTRAINT `user_info_foreign_key`
    ...
    REFERENCES `studdybuddy`.`user_login` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `studdybuddy`.`user_status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `studdybuddy`.`user_status` ;

CREATE TABLE IF NOT EXISTS `studdybuddy`.`user_status` (
